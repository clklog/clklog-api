...
@Schema(description = "分页获取用户访问列表的请求")
@Data
public class GetVisitorSessionUriListPageRequest {
...
//    private String endTime;
	...
	@Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "clklog")

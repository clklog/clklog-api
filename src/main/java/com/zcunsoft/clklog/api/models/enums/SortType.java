...
public enum SortType {
	...
	SourceWebSiteDetail("SourceWebSiteDetail", "来源网站分析", "sourcesite","asc", new String[]{"pv", "visitCount","newUv", "uv","ipCount","avgVisitTime","avgPv","bounceRate","pvRate","newUvRate","uvRate","ipCountRate","visitCountRate"}),

...
@Data
public class GetVisitUriDetailTotalRequest {
    ...
    @Schema(description = "String", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://app.huoqingqing.com/?time=&&event=bdstore#/")
    private String uri;
    
    @Schema(description = "String", requiredMode = Schema.RequiredMode.REQUIRED, example = "天天货清清")
